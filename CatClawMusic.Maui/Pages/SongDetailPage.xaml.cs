...
public partial class SongDetailPage : ContentPage
{
    ...
    private async void OnBackClicked(object? sender, EventArgs e)
    {
        ...
        {
            Log.Debug("SongDetailPage.xaml", $"[SongDetailPage] Back failed: {ex.Message}");
        }
    }
    ...
    private async void OnMoreClicked(object? sender, EventArgs e)
    {
        ...
        {
            Log.Debug("SongDetailPage.xaml", $"[SongDetailPage] More failed: {ex.Message}");
        }
    }
    ...
    private async Task PlaySongAsync(Core.Models.Song song)
    {
        ...
        {
            Log.Debug("SongDetailPage.xaml", $"[SongDetailPage] Play failed: {ex.Message}");
        }
    }
}
