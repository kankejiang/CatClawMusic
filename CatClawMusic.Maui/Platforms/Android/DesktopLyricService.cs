...
{
    private global::Android.Views.IViewManager? _windowManager;
    ...
    public void Show()
    {
        ...
        _windowManager = ctx.GetSystemService(Context.WindowService) as global::Android.Views.IViewManager;
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[DesktopLyric] AddView failed: {ex.Message}");
        }
    }

    public void Hide()
    {
        if (!IsShowing || _windowManager == null || _overlayView == null) return;
    ...
    {
        return await Task.FromResult(Settings.CanDrawOverlays(Application.Context));
    }
    ...
    internal void UpdatePosition(int y)
    {
        ...
        _layoutParams.Y = y;
        try { _windowManager.UpdateViewLayout(_overlayView, _layoutParams); } catch { }
